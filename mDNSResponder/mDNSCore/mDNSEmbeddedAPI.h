...
struct NetworkInterfaceInfo_struct
{
	...
	void *discoveryRelayLink;			// Pointer to private data structure, non-NULL if this is a
										// Discovery Relay virtual interface.
};
...
typedef void (*mDNSPlatformEventCallback)(int fd, short filter, void *context, mDNSBool encounteredEOF);
...
extern mStatus mDNSPlatformStopReadEvents(int fd, void *context);
...
extern mStatus mDNSPlatformRefreshInterfaceList( mDNS *m);
